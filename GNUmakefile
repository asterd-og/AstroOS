...
run:
	cp $(ISONAME) /mnt/c/Users/astrido/Documents
	cmd.exe /c "C:\Program Files\qemu\qemu-system-x86_64.exe" -M q35 -m 2G -smp 1 -s -cdrom "C:\Users\astrido\Documents\AstroOS.iso" -boot d -no-reboot -no-shutdown --serial stdio
